...
public class NamedParamsRetriever 
	 ...
	 */
	public NamedParamsRetriever(final Map<String,?> params) {
	 ...
	 *                       ({@link JSONRPC2Error#INVALID_PARAMS}).
	 */
	public Map<String,?> getMap(final String name)
		throws JSONRPC2Error {
	 ...
	 *                       ({@link JSONRPC2Error#INVALID_PARAMS}).
	 */
	public Map<String,?> getMap(final String name, final boolean allowNull)
		throws JSONRPC2Error {
		
		return (Map<String,?>)get(name, Map.class, allowNull);
	}
	 ...
	 *                       ({@link JSONRPC2Error#INVALID_PARAMS}).
	 */
	public Map<String,?> getOptMap(final String name, final Map<String,?> defaultValue)
		throws JSONRPC2Error {
	 ...
	 *                       ({@link JSONRPC2Error#INVALID_PARAMS}).
	 */
	public Map<String,?> getOptMap(final String name, final boolean allowNull, final Map<String,?> defaultValue)
		throws JSONRPC2Error {
	
		return (Map<String,?>)getOpt(name, Map.class, allowNull, defaultValue);
	}
}
