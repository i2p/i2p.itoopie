...
public class PositionalParamsRetriever
	 ...
	 *                       ({@link JSONRPC2Error#INVALID_PARAMS}).
	 */
	public Map<String,?> getMap(final int position)
		throws JSONRPC2Error {
	 ...
	 *                       ({@link JSONRPC2Error#INVALID_PARAMS}).
	 */
	public Map<String,?> getMap(final int position, final boolean allowNull)
		throws JSONRPC2Error {
		
		return (Map<String,?>)get(position, Map.class, allowNull);
	}
	 ...
	 *                       ({@link JSONRPC2Error#INVALID_PARAMS}).
	 */
	public Map<String,?> getOptMap(final int position, final Map<String,?> defaultValue)
		throws JSONRPC2Error {
	 ...
	 *                       ({@link JSONRPC2Error#INVALID_PARAMS}).
	 */
	public Map<String,?> getOptMap(final int position, final boolean allowNull, final Map<String,?> defaultValue)
		throws JSONRPC2Error {
	
		return (Map<String,?>)getOpt(position, Map.class, allowNull, defaultValue);
	}
}
